...
This is a fork of [emilybache/GildedRose-Refactoring-Kata](https://github.com/emilybache/GildedRose-Refactoring-Kata).

My solutions are each in their own branch, whose names start with `solution/`.\
There is one branch per programming language.
